...
(*                                                +#+#+#+#+#+   +#+           *)
(*   Created: 2015/06/22 11:40:08 by ngoguey           #+#    #+#             *)
(*   Updated: 2015/06/22 12:00:22 by ngoguey          ###   ########.fr       *)
(*                                                                            *)
(* ************************************************************************** *)
...
let () =
  ...
  | Sys_error m
	-> print_endline ("Catched \"" ^ m ^ "\" oh no !!")
					 ...
					 (*
ocamlopt joke.ml && ./a.out
ocamlopt joke.ml && ./a.out ""
ocamlopt joke.ml && ./a.out "/exam"
ocamlopt joke.ml && ./a.out "lul"
ocamlopt joke.ml && ./a.out "."
ocamlopt joke.ml && ./a.out empty.joke
ocamlopt joke.ml && ./a.out full.joke
ocamlopt joke.ml && ./a.out one.joke
					  *)
